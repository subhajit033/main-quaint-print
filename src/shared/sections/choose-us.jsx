...
const ChooseUs = () => {
 ...
 <div
    ...
    >
      ...
      <div className='w-[80%]  mx-auto' style={{ display: 'flex', justifyContent: "center", padding: '0rem 1rem' }}>
        <div className="  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10 mt-8 ">
          {/* Card 1 */}
          <ChooseUsCard
            icon={icon1}
