...
const FeatureBanner = () => {
  return (
    <section className='container px-10 py-10 my-10  lg:my-36 lg:px-0 mb-28'>
      <div className='flex flex-col items-center  gap-8 lg:flex-row lg:justify-center lg:items-center lg:gap-8'>
        ...
        <div className='flex flex-col gap-4 lg:block lg:space-y-8'>
          <div className='order-2'>
            <p className='text-3xl text-blue-600 kalamText'>
          ...
          <p className='text-lg text-gray-500 font-semibold leading-tight order-3 w-[100%]'>
