...
const SignUp = () => {
  ...
  const login = ApiService.userService.useRegister();
  ...
  const handleLogin = async (e) => {
    ...
    if (loginData.confirm_password) {
      delete loginData.confirm_password;
    }
    ...
    <div className="w-full h-screen flex justify-center items-center bg-[url('https://s3-alpha-sig.figma.com/img/dbe5/a32a/2b560528ce27966e2c86e01205ee56f8?Expires=1723420800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=qeCCRqp~3nY5zNPYkMy5CG0-oLJv30aCELK1uKaEoHWC2ECNFOO19YxDoQvhD0C-SY9xskeclrDAA~EYlOS0auPLxx7mRNG22DMpmIXdU3ru0ENOikUr7XHICJ5MtG5-L8FsvxV1kh2YkqZkBlHuv0d8GD02B1uof7lMJb4fTwXeZ4ir8fBv1DuRqOrmn1qFefgdNBdUZbmgLwfTVH8CgnjDi5a2pn60Qt--uSWtADCPdUNyYPr6asu5u5pppqgBzAnx84XJgmm~7sck5L4Ghj04d0t1s2a8ON5OZq0x0NmcGfhhWCGn7SiyFNRDw24c2y67lPtk6aQRha-GdSnB2w__')] bg-cover">
      <div className='p-6 w-[26rem] bg-white rounded-3xl'>
        ...
        <div className='my-4 flex items-center gap-4'>
          ...
          <p className='text-sm text-gray-800 text-center'></p>
          <hr className='w-full border-gray-300' />
        </div>
        <form onSubmit={handleLogin}>
          ...
          <div>
            ...
            <div className='relative flex items-center'>
              ...
              />
              <img
                className='w-[18px] h-[18px] absolute right-4 grayscale-[50%] opacity-30'
                src='https://www.svgrepo.com/show/472750/phone.svg'
                alt=''
              />
            </div>
          </div>
          <div className='mt-4'>
            ...
            <div className='relative flex items-center'>
              ...
              <svg
                ...
                viewBox='0 0 128 128'
                onClick={() =>
                  setShowPass2(showPass2 === 'text' ? 'password' : 'text')
                }
              >
                <path
          ...
          <div className='mt-4'>
            ...
            <div className='relative flex items-center'>
              ...
              <svg
                ...
                viewBox='0 0 128 128'
                onClick={() =>
                  setShowPass1(showPass1 === 'text' ? 'password' : 'text')
                }
              >
                <path
                  d='M64 104C22.127 104 1.367 67.496.504 65.943a4 4 0 0 1 0-3.887C1.367 60.504 22.127 24 64 24s62.633 36.504 63.496 38.057a4 4 0 0 1 0 3.887C126.633 67.496 105.873 104 64 104zM8.707 63.994C13.465 71.205 32.146 96 64 96c31.955 0 50.553-24.775 55.293-31.994C114.535 56.795 95.854 32 64 32 32.045 32 13.447 56.775 8.707 63.994zM64 88c-13.234 0-24-10.766-24-24s10.766-24 24-24 24 10.766 24 24-10.766 24-24 24zm0-40c-8.822 0-16 7.178-16 16s7.178 16 16 16 16-7.178 16-16-7.178-16-16-16z'
          ...
          <div className='mt-8'>
            <button
              type='submit'
              className='w-full py-3 px-6 flex justify-center items-center text-sm tracking-wide rounded-md text-white bg-[#84142E] hover:opacity-65 focus:outline-none'
